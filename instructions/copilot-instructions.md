...
18. Produza saída compatível com o contrato em `workflows/output-contract.json`.
19. Quando o escopo estiver grande ou ambíguo, reduza o escopo antes de gerar a documentação.
20. Não sugira commitar `.legacy-doc-agent/`.
21. Não armazene secrets, senhas, tokens ou credenciais na memória local.
